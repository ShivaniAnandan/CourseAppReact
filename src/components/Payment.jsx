...
//     const { totalPrice, courseIds  } = location.state || { totalPrice: 0, courseIds: []  }; // Get totalPrice from location state
...
//             <CheckoutForm totalPrice={totalPrice} courseIds={courseIds}/>
...
const Payment = () => {
    ...
    const courseIds = location.state.courseIds || []; // Get courseIds from location state
